...
<nav>
            ...
            <section className="section_y section1_bg">
                <Container >
                    <Row className="g-5" sm={1} md={1} lg={2} xl={2}>
                        <Col className="col-auto">
                            <div className="img_set">
                                <img src="http://ary-themes.com/html/bold_touch/medicoz/images/resource/image-1.png" className="img-fluid img_set1" alt="" srcset="" />
                                <img src="http://ary-themes.com/html/bold_touch/medicoz/images/resource/image-2.png" className="img-fluid img_set2" alt="" width={'300px'} srcset="" />
                                <img src="http://ary-themes.com/html/bold_touch/medicoz/images/resource/image-3.png" className="img_set3 img-fluid" alt="" srcset="" />
                            </div>
                        </Col>
                        <Col className="col-auto d-none d-md-block">
                            <div className="pt-5 mt-5">
                                <span className="section1_span">our medical</span>
                                <h2 className="mt-3">We're setting Standards in Research <br /> what's more, Clinical Care.</h2>

                                <p className="mt-3">We provide the most full medical services, so every person could have the pportunity o receive qualitative medical help.</p>
                                <p className="text-justify mt-4">Our Clinic has grown to provide a world class facility for the treatment of tooth loss, dental cosmetics and bore advanced restorative dentistry. We are among the most qualified implant providers in the AUS with over 30 years of uality training and experience.</p>
